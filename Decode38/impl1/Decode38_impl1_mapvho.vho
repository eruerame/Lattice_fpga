...
-- ldbanno -n VHDL -o Decode38_impl1_mapvho.vho -w -neg -gui Decode38_impl1_map.ncd 
-- Netlist created on Wed Oct 19 21:18:28 2022
-- Netlist written on Wed Oct 19 21:18:30 2022
...
-- entity SLICE_3
  ...
  begin
    i85_2_lut_3_lut: lut40005
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i94_2_lut_3_lut: lut40004
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
...
-- entity Decode38
  ...
  begin
    SLICE_0I: SLICE_0
      port map (C1=>sw_c_0, B1=>sw_c_1, A1=>sw_c_2, C0=>sw_c_1, B0=>sw_c_0, 
                A0=>sw_c_2, F0=>led_c_5, F1=>led_c_0);
    SLICE_1I: SLICE_1
      port map (C1=>sw_c_0, B1=>sw_c_1, A1=>sw_c_2, C0=>sw_c_1, B0=>sw_c_0, 
                A0=>sw_c_2, F0=>led_c_7, F1=>led_c_1);
    SLICE_2I: SLICE_2
      port map (C1=>sw_c_0, B1=>sw_c_1, A1=>sw_c_2, C0=>sw_c_1, B0=>sw_c_2, 
                A0=>sw_c_0, F0=>led_c_4, F1=>led_c_3);
    SLICE_3I: SLICE_3
      port map (C1=>sw_c_0, B1=>sw_c_1, A1=>sw_c_2, C0=>sw_c_1, B0=>sw_c_2, 
                A0=>sw_c_0, F0=>led_c_6, F1=>led_c_2);
    sw_0_I: sw_0_B
